...
StreamReader reader = new StreamReader(@"C:\Users\persian\Desktop\daneshjo.txt");
...
do
{
    ...
    Console.WriteLine("inter number7 for exit");
    ...
    if (n == 1)
    {
        foreach (var daneshjo in students)
        {
            ...
            Console.WriteLine(daneshjo.moadelhame);
    ...
    else if (n == 6)
    {
        foreach (var daneshjo in students)
        {
            ...
            Console.WriteLine("=");
            // Console.WriteLine(daneshjo.GREAD());
            Console.WriteLine("-------------------------------------");
